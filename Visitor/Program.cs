...
namespace Visitor
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Manager omer = new Manager { Name = "Ömer", Salary = 900 };

            Worker bilal = new Worker {Name = "Bilal", Salary = 800};
            Worker burhan = new Worker { Name = "Burhan", Salary = 800 };

            ali.Subordinates.Add(omer);
            omer.Subordinates.Add(bilal);
            omer.Subordinates.Add(burhan);
